...
<template>
    <div class="mt-5">
        <h2 class="text-center">{{ props.formCollection.survey ? props.formCollection.survey.title : null }}</h2>
        <div v-if="props.formCollection.formSectionCollection.length > 0" class="mt-5">
            <ul id="preview">
                <li v-for="(content, index) in props.formCollection.formSectionCollection.sort((a, b) => a.id - b.id )" :key="index"
                    ...
                    <div class="row w-100">
                        <div class="col">
                            ...
                            <div v-if="content.is_question">
                                <div v-if="content.option_type.multiple_select"
                                    :style="{ display: content.option_position }">
                                    <div class="mx-3" v-for="(option, index) in content.options" :key="index">
                                        <div class="form-check">
                                            <input :type="content.option_type.type" :name="'switch' + option.id"
                                                :id="'switch' + option.id" class="form-check-input"
                                                style="margin-top:5px" placeholder="Type something...">
                                ...
                                <div v-else class="mx-3 my-2">
                                    <div v-if="content.option_type.tag === 'text'">
                                        <input type="text" placeholder="Type something..."
                                            class="border p-2 w-50 outline-none inputfield"
                                            v-if="content.option_type.type === 'text'" />
